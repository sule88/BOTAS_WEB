package testAutomations.seleniumTests.CizimTasi;
...
public class CizimTasi extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//button[@id='btnCizimTasi']")
    public WebElement cizimTasi;
    ...
    @Test
    public void testCizimTasi() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(cizimTasi));
        cizimTasi.click();
