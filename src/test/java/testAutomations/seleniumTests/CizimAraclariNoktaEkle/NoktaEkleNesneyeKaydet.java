...
public class NoktaEkleNesneyeKaydet extends testAutomations.TestBase {
...
//    public WebElement koordinatyBtn;
    ...
    public WebElement görünürlükBtn;
...
//        koordinataGitBtn.click();
        ...
        Fwait.until(ExpectedConditions.visibilityOf(görünürlükBtn));
        görünürlükBtn.click();
        görünürlükBtn.getCssValue("82");
