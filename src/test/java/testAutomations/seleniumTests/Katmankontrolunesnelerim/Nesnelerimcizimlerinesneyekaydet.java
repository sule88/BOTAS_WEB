...
public class Nesnelerimcizimlerinesneyekaydet extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/button[3]")
    public WebElement nesneyeKaydet;
...
//    public WebElement botasDogalgazhattiBtn;
    ...
    @Test
    public void testNesnelerimcizimlerinesneyekaydet() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(nesneyeKaydet));
        nesneyeKaydet.click();
