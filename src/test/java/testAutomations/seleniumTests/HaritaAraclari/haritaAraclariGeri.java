...
public class haritaAraclariGeri extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[2]/div[1]/div[2]/div[9]/button[2]/i[1]")
    public WebElement geriBtn;



    @Test
    public void testharitaAraclariGeri() throws Exception {
        ...
        try {
            ...
            Logger.warn("Harita geri butonuna tıklamadı.");
        }
