...
public class Nesnelerimcizimleribagimsizgetir extends testAutomations.TestBase {
...
//    public WebElement tumnesnelerimBtn;
    ...
    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/button[4]/i[1]")
    public WebElement cizimleribagimsizgetir;

    @FindBy(css = "body > div.ui.page.modals.dimmer.transition.visible.active > div > div.actions > div > button.ui.green.button")
    public WebElement cizimlerigetir;
...
//        tumnesnelerimBtn.click();
        ...
        Fwait.until(ExpectedConditions.visibilityOf(cizimleribagimsizgetir));
        cizimleribagimsizgetir.click();

        Fwait.until(ExpectedConditions.visibilityOf(cizimlerigetir));
        cizimlerigetir.click();
        Thread.sleep(3000);
