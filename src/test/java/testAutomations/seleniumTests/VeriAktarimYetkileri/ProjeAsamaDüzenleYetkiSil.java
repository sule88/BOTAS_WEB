...
public class ProjeAsamaDüzenleYetkiSil extends testAutomations.TestBase {
...
//    public WebElement paylaşimiincele;
    ...
    @Test
    public void testProjeAsamaDüzenleYetkiSil() throws Exception {
...
//        mevcutBoruhatti.click();
       ...
       try {
        ...
        try {
            Fwait.until(ExpectedConditions.visibilityOf((Yetkiyisil)));
            Yetkiyisil.click();

        }catch (Exception e){
            Logger.warn("Yetki  silinmedi");
        }
