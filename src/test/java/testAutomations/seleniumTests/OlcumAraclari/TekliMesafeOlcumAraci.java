...
public class TekliMesafeOlcumAraci extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//button[@id='tekliMesafeOlcmeAraci']")
    public WebElement tekliMesafeOlcumBtn;
    ...
    @Test
    public void testTekliMesafeOlcumAraci() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(tekliMesafeOlcumBtn));
        tekliMesafeOlcumBtn.click();
        ...
        builder1.moveToElement(haritayatikla).clickAndHold().moveByOffset(500, 0).release().perform();
