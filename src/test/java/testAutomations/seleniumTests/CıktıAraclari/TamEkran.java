...
public class TamEkran extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[2]/div[1]/div[2]/div[7]/button[3]")
    ...
    @Test
    public void testTamEkran() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(tamEkran));
        tamEkran.click();
