package testAutomations.seleniumTests.CizimAraclariSecilenCizimiSil;
...
public class SecilenCizimiSil extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//button[@id='secilenCizimiSil']")
    public WebElement  secilenCizimiSil;
...
//    public WebElement koordinataGitBtn;
    ...
    @Test
    public void testSecilenCizimiSil() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(secilenCizimiSil));
        secilenCizimiSil.click();
