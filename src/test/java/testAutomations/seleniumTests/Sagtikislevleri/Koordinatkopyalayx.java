...
public class Koordinatkopyalayx extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//span[contains(text(),'Koordinatı Kopyala (YX)')]")
    public WebElement kopyalayx;
    ...
    public void testKoordinatkopyalaxy() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(kopyalayx));
        kopyalayx.click();
