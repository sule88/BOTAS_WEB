...
public class ProjeAsamaDüzenleYetkiSilİptal extends testAutomations.TestBase {
...
//    public WebElement paylaşimiincele;
    ...
    public WebElement ProjeAsamaYetkisiDuzenle;

    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[5]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/input[1]")
    public WebElement ProjeAsamaYetkisiDuzenlesearch;

    @FindBy(xpath = "//tbody/tr[5]/td[1]/div[1]/button[1]/span[1]/i[1]")
    public WebElement Konyaispartamevcuthatbtnsil;

    @FindBy(xpath = "//body/div[7]/div[1]/div[2]/div[1]/button[2]")
    public WebElement Yetkiyisiliptal;
    ...
    @Test
    public void testProjeAsamaDüzenleYetkiSilİptal() throws Exception {
...
//        mevcutBoruhatti.click();
        ...
        Fwait.until(ExpectedConditions.visibilityOf((ProjeAsamaYetkisiDuzenle)));
        ProjeAsamaYetkisiDuzenle.click();

        Fwait.until(ExpectedConditions.visibilityOf((ProjeAsamaYetkisiDuzenlesearch)));
        ProjeAsamaYetkisiDuzenlesearch.click();
        ProjeAsamaYetkisiDuzenlesearch.sendKeys("Konya");


       try {
           Fwait.until(ExpectedConditions.visibilityOf((Konyaispartamevcuthatbtnsil)));
           Konyaispartamevcuthatbtnsil.click();

       }catch (Exception e){
           Logger.warn("Konya-Isparta Mevcut hattı silinmedi");
       }


        try {
            Fwait.until(ExpectedConditions.visibilityOf((Yetkiyisiliptal)));
            Yetkiyisiliptal.click();

        }catch (Exception e){
            Logger.warn("Yetki  iptal tuşuna tıklanmadı.");
        }
