...
public class Koordinatkopyalaxy extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//span[contains(text(),'Koordinatı Kopyala (XY)')]")
    public WebElement kopyalaxy;

    @Test
    public void testKoordinatkopyalaxy() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(kopyalaxy));
        kopyalaxy.click();
