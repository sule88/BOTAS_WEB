package testAutomations.seleniumTests.CizimDondur;
...
public class CizimDondur extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//button[@id='btnCizimDondur']")
    public WebElement cizimDondur;

    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[1]/div[1]/canvas[1]")
    public WebElement cizim;

//    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[2]/div[1]/div[2]/div[2]/button[8]/i[1]")
//    public WebElement rotate;


//    @FindBy(xpath = "//body/div[@id='root']/div[1]/div[2]/div[1]/div[1]")
//    public WebElement cursor;
    ...
    @Test
    public void testCizimDondur() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(cizimDondur));
        cizimDondur.click();
...
//        Fwait.until(ExpectedConditions.visibilityOf(cursor));
//        cursor.click();
        ...
        new Actions(driver).moveToElement(canvasElement, 0, 50).clickAndHold().moveByOffset(50, 0).release().build().perform();
        Thread.sleep(3000);
