...
public class FormatliCiktiDuzenlejpeg extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//body/div[3]/form[1]/div[2]/div[1]/ul[1]/li[10]/select[1]/option[3]")
...
//        farkliKaydet.sendKeys(Keys.ENTER);
        ...
        Fwait.until(ExpectedConditions.visibilityOf(jpeg));
        jpeg.click();
